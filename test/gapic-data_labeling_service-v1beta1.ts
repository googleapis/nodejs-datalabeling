...
describe('v1beta1.DataLabelingServiceClient', () => {
    ...
    describe('createAnnotationSpecSet', () => {
        ...
        it('invokes createAnnotationSpecSet with error', done => {
            ...
            client.createAnnotationSpecSet(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('deleteAnnotationSpecSet', () => {
        ...
        it('invokes deleteAnnotationSpecSet with error', done => {
            ...
            client.deleteAnnotationSpecSet(request, (err: FakeError, response: {}) => {
                assert(err instanceof FakeError);
                assert.strictEqual(err.code, FAKE_STATUS_CODE);
                assert(typeof response === 'undefined');
                done();
    ...
    describe('labelImage', () => {
        it('invokes labelImage without error', done => {
            ...
            client.labelImage(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('labelVideo', () => {
        it('invokes labelVideo without error', done => {
            ...
            client.labelVideo(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('labelText', () => {
        it('invokes labelText without error', done => {
            ...
            client.labelText(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('createInstruction', () => {
        it('invokes createInstruction without error', done => {
            ...
            client.createInstruction(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('listDataItems', () => {
        it('invokes listDataItems without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listDataItems = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listDataItemsStream', () => {
        it('invokes listDataItemsStream without error', done => {
            ...
            const stream = client.listDataItemsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listAnnotatedDatasets', () => {
        it('invokes listAnnotatedDatasets without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listAnnotatedDatasets = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listAnnotatedDatasetsStream', () => {
        it('invokes listAnnotatedDatasetsStream without error', done => {
            ...
            const stream = client.listAnnotatedDatasetsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listExamples', () => {
        it('invokes listExamples without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listExamples = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listExamplesStream', () => {
        it('invokes listExamplesStream without error', done => {
            ...
            const stream = client.listExamplesStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listAnnotationSpecSets', () => {
        it('invokes listAnnotationSpecSets without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listAnnotationSpecSets = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listAnnotationSpecSetsStream', () => {
        it('invokes listAnnotationSpecSetsStream without error', done => {
            ...
            const stream = client.listAnnotationSpecSetsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listInstructions', () => {
        it('invokes listInstructions without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listInstructions = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listInstructionsStream', () => {
        it('invokes listInstructionsStream without error', done => {
            ...
            const stream = client.listInstructionsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('searchEvaluations', () => {
        it('invokes searchEvaluations without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.searchEvaluations = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('searchEvaluationsStream', () => {
        it('invokes searchEvaluationsStream without error', done => {
            ...
            const stream = client.searchEvaluationsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('searchExampleComparisons', () => {
        it('invokes searchExampleComparisons without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.searchExampleComparisons = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
            client.searchExampleComparisons(request, (err: FakeError, response: {}) => {
                assert.ifError(err);
                assert.deepStrictEqual(response, expectedResponse);
                done();
            });
    ...
    describe('searchExampleComparisonsStream', () => {
        it('invokes searchExampleComparisonsStream without error', done => {
            ...
            const stream = client.searchExampleComparisonsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
    ...
    describe('listEvaluationJobs', () => {
        it('invokes listEvaluationJobs without error', done => {
            ...
            const expectedResponse = {};
            // Mock Grpc layer
            client._innerApiCalls.listEvaluationJobs = (actualRequest: {}, options: {}, callback: Callback) => {
                assert.deepStrictEqual(actualRequest, request);
                callback(null, expectedResponse);
            };
    ...
    describe('listEvaluationJobsStream', () => {
        it('invokes listEvaluationJobsStream without error', done => {
            ...
            const stream = client.listEvaluationJobsStream(request, {}).on('data', (response: {}) =>{
                assert.deepStrictEqual(response, expectedResponse);
                done();
            }).on('error', (err: FakeError) => {
                done(err);
